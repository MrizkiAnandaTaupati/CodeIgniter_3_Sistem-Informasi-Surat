                    ...
                    <tbody>
                        <?php foreach ($surat as $key => $value): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('operator/surat/ubah_surat/'.$value['id_surat']."/".$id_perusahaan) ?>" class="btn-sm btn btn-warning text-white">Ubah</a>
                                    <a href="<?php echo base_url('operator/surat/hapus_surat/'.$value['id_surat']."/".$id_perusahaan) ?>" class="btn-sm btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus')">Hapus</a>
                                </td>
                            </tr>
                            <?php endforeach ?>
                    </tbody>
                </table>
                <a href=<?php echo base_url("operator/surat/tambah_surat"); ?> class="btn btn-primary">Tambah</a>
            </div>
		<div>
    <div>
</main>
