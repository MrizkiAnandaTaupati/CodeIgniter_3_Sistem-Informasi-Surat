...
<body>
  ...
  <aside id="sidebar" class="sidebar" style="background:#e9EFE5;">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url("admin/operator"); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url("admin/perusahaan"); ?>">
          <i class="bi bi-building"></i>
          <span>Perusahaan</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url("admin/user_dinas"); ?>">
          <i class="bi bi-building"></i>
