...
<body>
  ...
  <aside id="sidebar" class="sidebar" style="background:#e9EFE5;">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?php echo base_url("user_dinas/dashboard"); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url("user_dinas/profile"); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url("user_dinas/operator"); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url("user_dinas/perusahaan"); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url("user_dinas/logout"); ?>">
